"""FX-16: TimeSeriesMomentumStrategy run through run_backtest +
simulate_trades against real OANDA practice candles. Auto-skipped when
OANDA credentials aren't configured — same pattern as FX-14/FX-15's live
tests.
"""
...
@pytest.mark.asyncio
async def test_time_series_momentum_against_live_practice_candles(
    ...
    strategy = TimeSeriesMomentumStrategy(lookback=20, threshold=Decimal("0"))

"""FX-19: MeanReversionStrategy run through run_backtest + simulate_trades
against real OANDA practice candles. Auto-skipped when OANDA credentials
aren't configured — same pattern as FX-14/15/16's live tests.
"""
...
@pytest.mark.asyncio
async def test_mean_reversion_against_live_practice_candles(
    ...
    strategy = MeanReversionStrategy(period=20, entry_threshold=Decimal("2.0"))

"""FX-15: CloseChannelBreakoutStrategy run through run_backtest +
simulate_trades against real OANDA practice candles. Auto-skipped when
OANDA credentials aren't configured — same pattern as FX-14's live test.
"""
...
@pytest.mark.asyncio
async def test_close_channel_breakout_against_live_practice_candles(
    ...
    strategy = CloseChannelBreakoutStrategy(lookback=20)
